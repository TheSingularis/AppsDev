...
<main>
    ...
    <div class="multiForm">
        ...
        <form action="user_manager/index.php" method="post">
            ...
            <input type="text" name="email" value="testadmin@test.com" disabled class="form-control">
            <input type="text" name="password" value="admin" disabled class="form-control">
        ...
        <form action="user_manager/index.php" method="post">
            ...
            <input type="text" name="email" value="testuser@test.com" disabled class="form-control">
            <input type="text" name="password" value="user" disabled class="form-control">
